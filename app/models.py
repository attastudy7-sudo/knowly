...
# Changed 'user.id' to 'profiles.id'
...
class User(UserMixin, db.Model):
    ...
    """
    __tablename__ = 'profiles'  # This is the magic fix
...
# Subject and Document models remain largely the same, but ensure they exist
...
class Subject(db.Model):
    ...
    def update_post_count(self):
        ...
        self.post_count = self.posts.filter_by().count()
        db.session.commit()
